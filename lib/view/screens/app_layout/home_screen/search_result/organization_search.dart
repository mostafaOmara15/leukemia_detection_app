...
class OrganizationSearch extends StatefulWidget {
  ...
  @override
  State<OrganizationSearch> createState() => _OrganizationSearchState();

}

class _OrganizationSearchState extends State<OrganizationSearch> {
  final TextEditingController controller = TextEditingController();
  String? searchText = currentUser!.role == "community" ? currentUser?.nationalId : '';
              ...
              child: Container(
                child: StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection('patients')
                      .where('nationalId', isEqualTo: searchText)
                      .snapshots(),
